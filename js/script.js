...
function moveEverything(){
	...
	// enemy 2 spawn doesn't work properly because the Y position value is colliding with Enemy1 state
	// enemy2Y += enemy2SpeedY;
...
function drawEverything() {
	...
	// colorRect(enemy2X,enemy2Y,ENEMY_1_WIDTH,ENEMY_1_HEIGHT,"blue"); // enemy 2
	
	canvasContext.font="26px Helvetica";
	canvasContext.fillStyle="white";
	canvasContext.fillText("Time: ", 25, 50); 
};
